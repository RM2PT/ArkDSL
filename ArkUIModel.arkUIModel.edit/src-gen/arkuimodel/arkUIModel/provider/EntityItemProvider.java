...
/**
 * This is the item provider adapter for a {@link arkuimodel.arkUIModel.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends TypeCSItemProvider {
	/**
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ArkUIModelPackage.Literals.ENTITY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_description_feature",
								"_UI_Entity_type"),
						ArkUIModelPackage.Literals.ENTITY__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_superEntity_feature",
								"_UI_Entity_type"),
						ArkUIModelPackage.Literals.ENTITY__SUPER_ENTITY, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArkUIModelPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(ArkUIModelPackage.Literals.ENTITY__ENTITYREFRENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ArkUIModelPackage.Literals.ENTITY__ATTRIBUTES,
				ArkUIModelFactory.eINSTANCE.createEntityAttribute()));

		newChildDescriptors.add(createChildParameter(ArkUIModelPackage.Literals.ENTITY__ENTITYREFRENCE,
				ArkUIModelFactory.eINSTANCE.createEntityRefrence()));
	}
