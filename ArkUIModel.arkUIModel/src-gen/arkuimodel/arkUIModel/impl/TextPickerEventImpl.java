...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Text Picker Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link arkuimodel.arkUIModel.impl.TextPickerEventImpl#getOnChange <em>On Change</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextPickerEventImpl extends EventImpl implements TextPickerEvent {
	/**
	...
	protected EClass eStaticClass() {
		return ArkUIModelPackage.Literals.TEXT_PICKER_EVENT;
	}
	...
	public void setOnChange(String newOnChange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArkUIModelPackage.TEXT_PICKER_EVENT__ON_CHANGE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ArkUIModelPackage.TEXT_PICKER_EVENT__ON_CHANGE:
			return getOnChange();
		}
